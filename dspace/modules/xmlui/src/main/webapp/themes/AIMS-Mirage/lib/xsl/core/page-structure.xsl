    ...
    <xsl:template name="buildHead">
        <head>
            ...
            <script type="text/javascript">
                //<![CDATA[
                var _gaq = _gaq || [];
                _gaq.push(['_setAccount', 'UA-11221381-1']);
        ...
        <div id="ds-header-wrapper">
            <div id="ds-header" class="clearfix">
                <a id="ds-header-logo-link">
                    <xsl:attribute name="href">
                        <xsl:text>http://www.aims.gov.au/</xsl:text>
                    </xsl:attribute>
        ...
        <div id="ds-footer-wrapper">
            <div id="ds-footer">
                <div id="ds-footer-left">
                    <p>&#169; <script>document.write(new Date().getFullYear());</script> Australian Institute of Marine Science <a href="http://creativecommons.org/licenses/by/3.0/au/deed.en"><img src="http://weather.aims.gov.au/assets/images/cc.png" alt="creative commons" /></a></p>
                </div>
                <div id="ds-footer-links">
                    <a href="http://www.aims.gov.au/docs/cc-attribution.html">Attributing AIMS</a>
                    <xsl:text> | </xsl:text>
                    <a href="http://www.aims.gov.au/docs/cc-copyright.html">Copyright Notice</a>
                    <xsl:text> | </xsl:text>
                    <a href="http://www.aims.gov.au/docs/disclaimer.html">Disclaimer</a>
                    <xsl:text> | </xsl:text>
                    <a href="http://www.aims.gov.au/docs/privacy-policy.html">Privacy Policy</a>
                </div>
